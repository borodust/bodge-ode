...
(defparameter %ode::+na-n+ :double-nan)
...
(cffi:defctype %ode::dsizeint :unsigned-long-long)
...
(cffi:defctype %ode::dintptr :long-long)
...
(cffi:defcstruct (%ode::%io-file :size 208))

(cffi:defctype %ode::size-t :unsigned-long-long)
...
(cffi:defcstruct (%ode::%io-file :size 208)
                 ...
                 (%ode::%cur-column :unsigned-short :offset 124)
                 (%ode::%vtable-offset :char :offset 126)
                 (%ode::%shortbuf :char :count 1 :offset 127)
                 (%ode::%lock
                  (claw-utils:claw-pointer %ode::%io-lock-t) :offset
                  128)
                 (%ode::%offset %ode::%%off64-t :offset 136)
                 (%ode::%codecvt
                  (claw-utils:claw-pointer
                 ...
                 (%ode::%freeres-buf (claw-utils:claw-pointer :void)
                  :offset 168)
                 (%ode::%%pad5 %ode::size-t :offset 176)
                 (%ode::%mode :int :offset 184)
                 (%ode::%unused2 :char :count 20 :offset 188))
...
(cffi:defcstruct (%ode::stopwatch :size 16)
...
(cffi:defcstruct (%ode::x-threaded-wait-time :size 8)
                 (%ode::wait-sec %ode::time-t :offset 0)
                 (%ode::wait-nsec :unsigned-long :offset 4))
